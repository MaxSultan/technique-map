 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bx(t){cr(new Vn("platform-logger",e=>new Kk(e),"PRIVATE")),cr(new Vn("heartbeat",e=>new kx(e),"PRIVATE")),Sn(wp,E0,t),Sn(wp,E0,"esm2017"),Sn("fire-js","")}bx("");var Nx="firebase",Ox="10.11.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function xT(t,e,n=!1){if(Zn(t.app))return Promise.reject(Sr(t));const r="signIn",i=await kT(t,r,e),s=await es._fromIdTokenResponse(t,r,i);return n||await t._updateCurrentUser(s.user),s}async function xD(t,e){return xT(fs(t),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function DT(t){const e=fs(t);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function DD(t,e,n){if(Zn(t.app))return Promise.reject(Sr(t));const r=fs(t),o=await Ap(r,{returnSecureToken:!0,email:e,password:n,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",CD).catch(l=>{throw l.code==="auth/password-does-not-meet-requirements"&&DT(t),l}),a=await es._fromIdTokenResponse(r,"signIn",o);return await r._updateCurrentUser(a.user),a}function bD(t,e,n){return Zn(t.app)?Promise.reject(Sr(t)):xD(wt(t),No.credential(e,n)).catch(async r=>{throw r.code==="auth/password-does-not-meet-requirements"&&DT(t),r})}function ND(t,e,n,r){return wt(t).onIdTokenChanged(e,n,r)}function OD(t,e,n){return wt(t).beforeAuthStateChanged(e,n)}const Tc="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function or(){return window}function UD(t){or().location.href=t}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function MT(){return typeof or().WorkerGlobalScope<"u"&&typeof or().importScripts=="function"}async function zD(){if(!(navigator!=null&&navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function BD(){var t;return((t=navigator==null?void 0:navigator.serviceWorker)===null||t===void 0?void 0:t.controller)||null}function HD(){return MT()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nb="pendingRedirect",$u=new Map;class rb extends jT{constructor(e,n,r=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],n,void 0,r),this.eventId=null}async execute(){let e=$u.get(this.auth._key());if(!e){try{const r=await ib(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(r)}catch(n){e=()=>Promise.reject(n)}$u.set(this.auth._key(),e)}return this.bypassAuthState||$u.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const n=await this.auth._redirectUserForId(e.eventId);if(n)return this.user=n,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function ib(t,e){const n=ab(e),r=ob(t);if(!await r._isAvailable())return!1;const i=await r._get(n)==="true";return await r._remove(n),i}function sb(t,e){$u.set(t._key(),e)}function ob(t){return Er(t._redirectPersistence)}function ab(t){return Fu(nb,t.config.apiKey,t.name)}async function lb(t,e,n=!1){if(Zn(t.app))return Promise.reject(Sr(t));const r=fs(t),i=XD(r,e),o=await new rb(r,i,n).execute();return o&&!n&&(delete o.user._redirectEventId,await r._persistUserIfCurrent(o.user),await r._setRedirectUser(null,e)),o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yb=new Tl(3e4,6e4);function $0(){const t=or().___jsl;if(t!=null&&t.H){for(const e of Object.keys(t.H))if(t.H[e].r=t.H[e].r||[],t.H[e].L=t.H[e].L||[],t.H[e].r=[...t.H[e].L],t.CP)for(let n=0;n<t.CP.length;n++)t.CP[n]=null}}function vb(t){return new Promise((e,n)=>{var r,i,s;function o(){$0(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{$0(),n(sr(t,"network-request-failed"))},timeout:yb.get()})}if(!((i=(r=or().gapi)===null||r===void 0?void 0:r.iframes)===null||i===void 0)&&i.Iframe)e(gapi.iframes.getContext());else if(!((s=or().gapi)===null||s===void 0)&&s.load)o();else{const a=dD("iframefcb");return or()[a]=()=>{gapi.load?o():n(sr(t,"network-request-failed"))},RT(`${cD()}?onload=${a}`).catch(l=>n(l))}}).catch(e=>{throw ju=null,e})}let ju=null;function _b(t){return ju=ju||vb(t),ju}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ub(t){switch(t){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function zb(t){cr(new Vn("auth",(e,{options:n})=>{const r=e.getProvider("app").getImmediate(),i=e.getProvider("heartbeat"),s=e.getProvider("app-check-internal"),{apiKey:o,authDomain:a}=r.options;te(o&&!o.includes(":"),"invalid-api-key",{appName:r.name});const l={apiKey:o,authDomain:a,clientPlatform:t,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:AT(t)},u=new aD(r,i,s,l);return gD(u,n),u},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,n,r)=>{e.getProvider("auth-internal").initialize()})),cr(new Vn("auth-internal",e=>{const n=fs(e.getProvider("auth").getImmediate());return(r=>new jb(r))(n)},"PRIVATE").setInstantiationMode("EXPLICIT")),Sn(z0,B0,Ub(t)),Sn(z0,B0,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rs=new cd("@firebase/firestore");function Jo(){return rs.logLevel}function j(t,...e){if(rs.logLevel<=we.DEBUG){const n=e.map(Gg);rs.debug(`Firestore (${Mo}): ${t}`,...n)}}function dr(t,...e){if(rs.logLevel<=we.ERROR){const n=e.map(Gg);rs.error(`Firestore (${Mo}): ${t}`,...n)}}function yo(t,...e){if(rs.logLevel<=we.WARN){const n=e.map(Gg);rs.warn(`Firestore (${Mo}): ${t}`,...n)}}function Gg(t){if(typeof t=="string")return t;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
This typically indicates that your device does not have a healthy Internet connection at the moment. The client will operate in offline mode until it is able to successfully connect to the backend.`;this.g_?(dr(n),this.g_=!1):j("OnlineStateTracker",n)}b_(){this.f_!==null&&(this.f_.cancel(),this.f_=null)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gA{constructor(e){this.observer=e,this.muted=!1}next(e){this.observer.next&&this.qa(this.observer.next,e)}error(e){this.observer.error?this.qa(this.observer.error,e):dr("Uncaught Error in snapshot listener:",e.toString())}Qa(){this.muted=!0}qa(e,n){this.muted||setTimeout(()=>{this.muted||e(n)},0)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`,j$=q(({className:t,content:e,addToPracticePlan:n,area:r,moves:i})=>{const{showPanel:s,setPanelContent:o,setPanelTitle:a}=T.useContext(zy),[l,u]=T.useState([]),{id:c=""}=Gy(),d=g=>fr(_s(zn(Je,"practice_plan"),ws("teamId","==",g))).then(f=>{const p=f.docs.map(v=>({...v.data(),id:v.id})).sort((v,S)=>Number(S.date.seconds)-Number(v.date.seconds));u(p)}).catch(f=>{throw new Error(f)});T.useEffect(()=>{d(c)},[]);const h=50,m=70,_=g=>{const f="50%",p="25%",v="75%";return g%3===1||g===0?f:g%6===2||g%6===3?p:v},w=g=>{o(g),s()};return y.jsx("svg",{height:Math.max(110*(e.length+2),window.innerHeight-52),width:"100%",className:t,children:e.map((g,f)=>y.jsxs("g",{children:[y.jsx("line",{x1:_(f),y1:m+f*110,x2:_(f+1),y2:m+(f+1)*110}),y.jsx(F$,{r:h,y:m+f*110,x:_(f),onClick:()=>{a(g),w(()=>y.jsx(y.Fragment,{children:i.filter(p=>p.area===r&&p.position===g).map(p=>y.jsx($$,{position:g,area:r,move:p,addToPracticePlan:n,practicePlans:l}))}))},text:g})]},g))})})`
  min-height: 100%;
  background: linear-gradient(var(--blue100), var(--blue900));
...
`,ER=t=>!isNaN(t),Qy=(t,e)=>e.map(n=>t.find(r=>r.id===n)),Yy=t=>t.reduce((e,n)=>{var r;return{...e,[n==null?void 0:n.area]:[...(e[n==null?void 0:n.area]??[]).filter(i=>i.name!==(n==null?void 0:n.position)),{name:n==null?void 0:n.position,moves:[...((r=(e[n==null?void 0:n.area]??[]).find(i=>i.name===(n==null?void 0:n.position)))==null?void 0:r.moves)??[],{name:n==null?void 0:n.name,id:n==null?void 0:n.id}]}]}},{neutral:[],top:[],bottom:[]}),Dw=t=>t.reduce((e,n)=>{const r=e.findIndex(i=>i.name===n.area);return e[r].positions.add(n.position),e},[{name:"neutral",positions:new Set},{name:"top",positions:new Set},{name:"bottom",positions:new Set}]),U$=(t,e)=>window.navigator.clipboard.writeText(JSON.stringify(Yy(Qy(t,e)))),z$=async(t,e)=>{if(!ER(t.date)){alert("please submit a valid date");return}await Py(zn(Je,"practice_plan"),t).then(n=>{e(`/teams/${t.teamId}/practice_plans/${n.id}`)})},B$=async(t,e,n)=>{const r=Tn(Je,"practice_plan",t);if(!ER(e.date)){alert("please submit a valid date");return}await Wi(r,e),n(`/teams/${e.teamId}/practice_plans/${t}`)},H$=q.div`
  height: 100%;
  overflow: scroll;
`,W$=q.div`
  display: grid;
  grid-auto-flow: row;
  gap: 20px;
`,q$=q.input``,bw=q(({className:t,moves:e,practicePlanMoves:n,practicePlanDate:r,removeFromPracticePlan:i,clearPracticePlan:s,currentPracticePlanId:o,updatePracticePlanDate:a,teamId:l})=>{const u=Es(),[c,d]=T.useState(window.innerWidth>850),{closePanel:h}=T.useContext(zy);T.useEffect(()=>()=>h(),[]);const m=()=>{window.innerWidth>850&&d(!0)};T.useLayoutEffect(()=>(window.addEventListener("resize",m),()=>{window.removeEventListener("resize",m)}),[]);const _=()=>{d(g=>!g)},w=g=>{const[f,p,v]=g.split("-");return new Date(`${p}/${v}/${f}`)};return y.jsxs("aside",{className:t,style:{"--transform":c?"translateX(0%)":"translateX(-100%)"},children:[y.jsx("button",{"aria-label":"show practice plan",onClick:_,children:y.jsx(a$,{})}),y.jsxs(H$,{children:["Date:",y.jsx(q$,{type:"date",value:r,onChange:g=>a(g.target.value)}),y.jsx("h1",{children:"Practice Plan"}),Object.entries(Yy(Qy(e,n))).map(([g,f])=>y.jsxs(T.Fragment,{children:[y.jsx("h2",{children:g}),f.map(p=>y.jsx(Wc,{title:p.name,children:p.moves.map(({name:v,id:S})=>y.jsxs(G$,{children:[v,y.jsx(Q$,{onClick:()=>i(S),children:y.jsx(mh,{})})]},`${p.name}=${v}`))},p.name))]},g)),y.jsxs(W$,{children:[!o&&y.jsx(oo,{onClick:s,text:"Clear Practice Plan",Icon:K$,$level:"caution"}),y.jsx(oo,{onClick:()=>U$(e,n),text:"Copy Practice Plan",Icon:r$}),y.jsx(oo,{onClick:()=>{o?B$(o,{moves:n,date:w(r),teamId:l},u):z$({moves:n,date:w(r),teamId:l},u)},text:o?"Update Practice Plan":"Save Practice Plan",Icon:i$})]})]})]})})`
  background: linear-gradient(var(--blue100), var(--blue900));
  color: white;
...
`,Q$=q.button`
  ...
  justify-content: center;
  align-items: center;
`,Nw=t=>{const[e,n,r]=new Date(t).toLocaleDateString("en-US").split("/");return`${r}-${e.padStart(2,"0")}-${n.padStart(2,"0")}`},Y$=t=>{const[e,n]=T.useState([]),[r,i]=T.useState(Nw(new Date));return T.useEffect(()=>{if(t){const s=_s(zn(Je,"practice_plan"),ws(TA(),"==",t));fr(s).then(a=>{const l=a.docs.map(c=>({...c.data(),id:c.id})),[u]=l;i(Nw(new Date(Number(u.date.seconds)*1e3))),n(u.moves)})}},[t]),[e,n,r,i]},X$=t=>fr(_s(zn(Je,"moves"),ws("teamId","==",t))).then(e=>e.docs.map(n=>({...n.data(),id:n.id}))),Ow=q(({className:t})=>{const[e,n]=T.useState("neutral"),[r,i]=T.useState([]),{addToast:s,removeToast:o}=T.useContext(Kl),{practice_plan_id:a,id:l=""}=Gy(),[u,c,d,h]=Y$(a);T.useEffect(()=>{X$(l).then(f=>i(f))},[l]);const m=()=>{h(new Date),c([]),s({variant:"success",message:"practice plan cleared",onClose:()=>o("practice plan cleared")})},_=f=>{c(p=>p.includes(f)?(s({variant:"success",message:"move already exists",onClose:()=>o("move already exists")}),p):(s({variant:"success",message:"move was successfully added",onClose:()=>o("move was successfully added")}),[...p,f]))},w=f=>{c(p=>[...p].filter(v=>v!==f)),s({variant:"success",message:"move was successfully removed",onClose:()=>o("move was successfully removed")})},g=f=>{h(f),s({variant:"success",message:"practice plan date updated",onClose:()=>o("practice plan date updated")})};return y.jsxs("main",{className:t,children:[y.jsx(lw,{tabs:Dw(r).map(f=>f.name),currentTab:e,setCurrentTab:n}),y.jsx(bw,{moves:r,practicePlanMoves:u,practicePlanDate:d,clearPracticePlan:m,removeFromPracticePlan:w,currentPracticePlanId:a,updatePracticePlanDate:g,teamId:l}),y.jsx(j$,{addToPracticePlan:_,content:[...Dw(r).find(f=>f.name===e).positions],area:e,moves:r})]})})`
  display: grid;
...
`,J$=q.ul`
  ...
  margin: 0;
  padding: 0;
`,Z$=q(({className:t})=>{const[e,n]=T.useState({date:new Date,moves:[],id:""}),[r,i]=T.useState([]),s=jo(),o=Es(),a=s.pathname.split("/").at(-1)??"",l=_s(zn(Je,"practice_plan"),ws(TA(),"==",a)),u=()=>fr(zn(Je,"moves")).then(h=>{const m=h.docs.map(_=>({..._.data(),id:_.id}));i(m)}),c=()=>fr(l).then(h=>{const m=h.docs.map(w=>({...w.data(),id:w.id})),[_]=m;n(_)});T.useEffect(()=>{u(),c()},[]);const d=h=>{o("edit")};return y.jsxs("main",{className:t,children:[Object.entries(Yy(Qy(r,e.moves))).map(([h,m])=>y.jsxs(J$,{children:[y.jsx("h2",{children:h}),m.map(_=>y.jsx("li",{children:y.jsx(Wc,{title:_.name,open:!0,children:y.jsx("ul",{children:_==null?void 0:_.moves.map(w=>y.jsx("li",{children:w.name},`${_.name}-${w.name}`))})})},_.name))]},h)),y.jsx(oo,{onClick:()=>d(),text:"Edit Practice Plan",Icon:o$,$level:"caution"})]})})`
  min-height: 100%;
  background: linear-gradient(var(--blue100), var(--blue900));
  padding: 32px;
  color: white;
...
`,e5=["AL","AK","AZ","AR","CA","CO","CT","DE","FL","GA","HI","ID","IL","IN","IA","KS","KY","LA","ME","MD","MA","MI","MN","MS","MO","MT","NE","NV","NH","NJ","NM","NY","NC","ND","OH","OK","OR","PA","RI","SC","SD","TN","TX","UT","VT","VA","WA","WV","WI","WY"],Xy=zn(Je,"teams"),t5=()=>fr(Xy).then(t=>t.docs.map(n=>({...n.data(),id:n.id}))),n5=t=>{const e=_s(Xy,ws("userIds","array-contains",t));return fr(e).then(n=>n.docs.map(i=>({...i.data(),id:i.id})))},r5=q(({className:t})=>{const[e,n]=T.useState([]),[r,i]=T.useState([]),s=T.useContext(Uo),{addToast:o,removeToast:a}=T.useContext(Kl),l=T.useRef(),u=T.useRef(),c=()=>{l.current&&l.current.showModal()},d=()=>{l.current&&l.current.close()},h=()=>{u.current&&u.current.showModal()},m=()=>{u.current&&u.current.close()},_=g=>{g.preventDefault();const f=new FormData(g.currentTarget),p={name:f.get("teamName"),state:f.get("stateLocation"),joinRequests:[],userIds:[s.uid],users:[{role:"admin",uid:s.uid}]};Py(Xy,p).then(v=>{console.log(v),i(S=>[...S,{...p,id:v.id}]),d()})},w=g=>{g.preventDefault();const f=new FormData(g.currentTarget);Wi(Tn(Je,"teams",f.get("teamToJoin")),{joinRequests:jc({userEmail:s.email,uid:s.uid,role:f.get("requestedRole")})}).then(()=>{m(),o({variant:"success",message:"Request Successfully Submitted",onClose:()=>a("Request Successfully Submitted")})})};return T.useEffect(()=>{t5().then(g=>n(g)),s!=null&&s.uid&&n5(s.uid).then(g=>i(g))},[s]),y.jsxs("main",{className:t,children:[y.jsx("h1",{children:"My Teams"}),y.jsx("ul",{children:r.map(g=>y.jsx("li",{children:y.jsx(Wc,{title:y.jsxs(vh,{to:`${g.id}`,children:[g.name," (",g.state,")"]})})},g.id))}),y.jsx("button",{onClick:h,children:"Request to Join a Team"}),y.jsx("button",{onClick:c,children:"Create a Team"}),y.jsx(ao,{passedRef:l,onClose:d,children:y.jsxs("form",{onSubmit:_,children:[y.jsxs("label",{htmlFor:"teamName",children:[y.jsx("span",{children:"Team Name:"}),y.jsx("input",{name:"teamName",type:"text",id:"teamName"})]}),y.jsxs("label",{htmlFor:"stateLocation",children:[y.jsx("span",{children:"State:"}),y.jsx("select",{name:"stateLocation",id:"stateLocation",children:e5.map(g=>y.jsx("option",{value:g,children:g},g))})]}),y.jsx("button",{type:"submit",children:"Create"})]})}),y.jsx(ao,{passedRef:u,onClose:m,children:y.jsxs("form",{onSubmit:w,children:[y.jsxs("label",{htmlFor:"teamToJoin",children:[y.jsx("span",{children:"Team:"}),y.jsx("select",{name:"teamToJoin",id:"teamToJoin",children:e.map(g=>y.jsxs("option",{value:g.id,children:[g.name," (",g.state,")"]},g.id))})]}),y.jsxs("label",{htmlFor:"requestedRole",children:[y.jsx("span",{children:"Requested Role:"}),y.jsx("select",{name:"requestedRole",id:"requestedRole",children:["admin","base+","base"].map(g=>y.jsx("option",{value:g,children:g},g))})]}),y.jsx("button",{type:"submit",children:"Send Request to Join"})]})})]})})`
  height: 100%;
  background: linear-gradient(var(--blue100), var(--blue900));
  color: white;
...
`,u5=q.div`
  ...
  padding: 4px 8px;
  white-space: nowrap;
`,c5=q(({className:t,move:e})=>y.jsx("li",{className:t,children:y.jsxs("div",{children:[y.jsx("h3",{children:e.name}),y.jsxs("span",{children:[e.area," - ",e.position]}),y.jsx(u5,{level:e.level,children:e.level})]})}))`
  & > div {
    display: grid;
    gap: 4px;
    border: 1px solid white;
...
`,h5=FF(um(y.jsxs(Gn,{path:"/",element:y.jsx(n$,{}),children:[y.jsx(Gn,{path:"teams/:id/practice_plans/create",element:y.jsx(Ow,{})}),y.jsx(Gn,{path:"/practice_plans",element:y.jsx(V$,{})}),y.jsx(Gn,{path:"teams/:id/practice_plans/:practice_plan_id",element:y.jsx(Z$,{})}),y.jsx(Gn,{path:"/teams",element:y.jsx(r5,{})}),y.jsx(Gn,{path:"/teams/:id",element:y.jsx(d5,{})}),y.jsx(Gn,{path:"teams/:id/practice_plans/:practice_plan_id/edit",element:y.jsx(Ow,{})}),y.jsx(Gn,{path:"/sign_in",element:y.jsx(ZF,{})}),y.jsx(Gn,{path:"/sign_up",element:y.jsx(e$,{})})]}))),f5=q(({className:t})=>y.jsx("div",{className:t,children:y.jsx(t$,{children:y.jsx(k$,{children:y.jsxs(S4,{children:[y.jsx(qF,{router:h5}),y.jsx(d$,{})]})})})}))`
  height: 100%;
...
`,p5=QE(document.getElementById("root"));async function m5(){if(!["development","test"].includes("production"))return;const{worker:t}=await kR(()=>import("./browser-UkVwgeuH.js"),__vite__mapDeps([]));return t.start({serviceWorker:{url:"/technique-map/mockServiceWorker.js"}})}m5().then(()=>{p5.render(y.jsx(T.StrictMode,{children:y.jsx(f5,{})}))});
